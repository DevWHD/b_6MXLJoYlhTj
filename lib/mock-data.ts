...
export const contacts: Contact[] = [
  // 1º Andar
  { id: "c1", name: "Recepção Emergência", floor: "1º Andar", ramais: ["2088-1300", "3878-2327"], icon: "Users" },
  { id: "c2", name: "Acolhimento", floor: "1º Andar", ramais: ["2088-1301"], icon: "UserRound" },
  { id: "c3", name: "Emergência", floor: "1º Andar", ramais: ["2088-1302"], icon: "ShieldAlert" },
  { id: "c4", name: "Ambulatório (Chefia)", floor: "1º Andar", ramais: ["2088-1303"], icon: "Stethoscope" },
  { id: "c5", name: "Ambulatório (Registro Geral)", floor: "1º Andar", ramais: ["2088-1304"], icon: "FileText" },
  { id: "c6", name: "Ambulatório (Procedimento)", floor: "1º Andar", ramais: ["2088-1305"], icon: "Syringe" },
  { id: "c7", name: "NIR (Admissão e Alta)", floor: "1º Andar", ramais: ["2088-1306", "3878-1845"], icon: "BedDouble" },
  // 2º Andar
  { id: "c8", name: "Portaria Principal", floor: "2º Andar", ramais: ["2088-1307"], icon: "Users" },
  { id: "c9", name: "Faturamento (AIH/GIL/CNES)", floor: "2º Andar", ramais: ["2088-1308"], icon: "Receipt" },
  { id: "c10", name: "Faturamento (Chefia)", floor: "2º Andar", ramais: ["3878-2544"], icon: "Receipt" },
  { id: "c11", name: "Documentação Médica", floor: "2º Andar", ramais: ["2088-1309"], icon: "FileText" },
  { id: "c12", name: "Manutenção (Chefia)", floor: "2º Andar", ramais: ["2088-1310"], icon: "Wrench" },
  { id: "c13", name: "Radiologia", floor: "2º Andar", ramais: ["2088-1311"], icon: "ScanLine" },
  { id: "c14", name: "Rouparia", floor: "2º Andar", ramais: ["2088-1312"], icon: "Package" },
  { id: "c15", name: "Farmácia", floor: "2º Andar", ramais: ["2088-1313", "3895-5616"], icon: "Pill" },
  { id: "c16", name: "Cozinha/Firma", floor: "2º Andar", ramais: ["2088-1314"], icon: "Salad" },
  { id: "c17", name: "Almoxarifado", floor: "2º Andar", ramais: ["2088-1315", "3895-5208"], icon: "Package" },
  { id: "c18", name: "Anatomia Patológica", floor: "2º Andar", ramais: ["2088-1316"], icon: "Microscope" },
  { id: "c19", name: "Cantina", floor: "2º Andar", ramais: ["2088-1317"], icon: "Salad" },
  { id: "c20", name: "Associação (Bazar)", floor: "2º Andar", ramais: ["2088-1318"], icon: "ShoppingCart" },
  { id: "c21", name: "Cartório", floor: "2º Andar", ramais: ["2088-1319"], icon: "FileText" },
  // 3º Andar
  { id: "c22", name: "Direção / Secretária", floor: "3º Andar", ramais: ["2088-1320", "3878-1498"], icon: "Briefcase" },
  { id: "c23", name: "Coordenação Médica", floor: "3º Andar", ramais: ["2088-1321", "3878-2371"], icon: "Stethoscope" },
  { id: "c24", name: "Coordenadora ADM", floor: "3º Andar", ramais: ["2088-1322", "3895-2396"], icon: "LayoutDashboard" },
  { id: "c25", name: "Assessoria Médica", floor: "3º Andar", ramais: ["3895-3453"], icon: "Stethoscope" },
  { id: "c26", name: "Assessoria ADM", floor: "3º Andar", ramais: ["2088-1324", "3878-1548"], icon: "LayoutDashboard" },
  { id: "c27", name: "Apoio Administrativo", floor: "3º Andar", ramais: ["2088-1326"], icon: "LayoutDashboard" },
  { id: "c28", name: "Assessoria da Direção", floor: "3º Andar", ramais: ["2088-1327"], icon: "Briefcase" },
  { id: "c29", name: "Laboratório", floor: "3º Andar", ramais: ["2088-1328"], icon: "FlaskConical" },
  { id: "c30", name: "Comunicação / Xerox", floor: "3º Andar", ramais: ["2088-1329"], icon: "FileText" },
  { id: "c31", name: "Centro de Estudos", floor: "3º Andar", ramais: ["2088-2207"], icon: "BookOpen" },
  { id: "c32", name: "Gerência de Contratos", floor: "3º Andar", ramais: ["2088-1331", "3878-1837"], icon: "FileText" },
  { id: "ti1", name: "TI", floor: "3º Andar", ramais: ["2088-1331"], icon: "Monitor" },
  { id: "c33", name: "Recursos Humanos", floor: "3º Andar", ramais: ["2088-1332", "3895-5138"], icon: "Users" },
  { id: "c34", name: "Diretora", floor: "3º Andar", ramais: ["3878-2562"], icon: "Briefcase" },
  // 4º Andar
  { id: "c35", name: "Nutrição", floor: "4º Andar", ramais: ["2088-1333", "2088-1334"], icon: "Salad" },
  { id: "c36", name: "Chefia Nutrição", floor: "4º Andar", ramais: ["2088-1335"], icon: "Salad" },
  { id: "c37", name: "Banco de Leite", floor: "4º Andar", ramais: ["2088-1336"], icon: "Baby" },
  { id: "c38", name: "Supervisão Enfermagem", floor: "4º Andar", ramais: ["2088-1338"], icon: "Heart" },
  { id: "c39", name: "Hall - Recepção / Vigilância", floor: "4º Andar", ramais: ["2088-1339"], icon: "ShieldCheck" },
  { id: "c40", name: "Chefia Neonatal (Enfermagem)", floor: "4º Andar", ramais: ["2088-1340"], icon: "Heart" },
  { id: "c41", name: "UTI Neo Natal", floor: "4º Andar", ramais: ["2088-1341"], icon: "Baby" },
  { id: "c42", name: "UI Neonatal", floor: "4º Andar", ramais: ["2088-1342"], icon: "Baby" },
  { id: "c43", name: "Equipe Médica Neonatal", floor: "4º Andar", ramais: ["2088-1343"], icon: "Baby" },
  { id: "c44", name: "Quarto dos Médicos (Neonatologia)", floor: "4º Andar", ramais: ["2088-1343"], icon: "BedDouble" },
  // 5º Andar
  { id: "c45", name: "Posto de Enfermagem (AC)", floor: "5º Andar", ramais: ["2088-1344", "2088-1345"], icon: "Heart" },
  { id: "c46", name: "Enfermaria Canguru", floor: "5º Andar", ramais: ["2088-1346"], icon: "Baby" },
  { id: "c47", name: "Hemoterapia", floor: "5º Andar", ramais: ["3895-5548", "2088-1347"], icon: "Syringe" },
  { id: "c48", name: "Citopatologia", floor: "5º Andar", ramais: ["2088-1348"], icon: "FlaskConical" },
  { id: "c49", name: "Saúde Mental", floor: "5º Andar", ramais: ["2088-1350"], icon: "UserRound" },
  { id: "c50", name: "Serviço Social", floor: "5º Andar", ramais: ["2088-1350", "3895-2518"], icon: "HandHeart" },
  // 6º Andar
  { id: "c51", name: "Posto de Enfermagem (AC)", floor: "6º Andar", ramais: ["2088-1351"], icon: "Heart" },
  { id: "c52", name: "Posto de Enfermagem (Ginecologia)", floor: "6º Andar", ramais: ["2088-1352"], icon: "Heart" },
  { id: "c53", name: "Chefia Seção de Enfermagem", floor: "6º Andar", ramais: ["2088-1353"], icon: "Heart" },
  { id: "c54", name: "Associação de Funcionários", floor: "6º Andar", ramais: ["2088-1349"], icon: "Users" },
  // 7º Andar
  { id: "c55", name: "Posto de Enfermagem - Ala A", floor: "7º Andar", ramais: ["2088-1354"], icon: "Heart" },
  { id: "c56", name: "Posto de Enfermagem - Ala B", floor: "7º Andar", ramais: ["2088-1355"], icon: "Heart" },
  { id: "c57", name: "Ultrassonografia", floor: "7º Andar", ramais: ["2088-1356"], icon: "ScanLine" },
  { id: "c58", name: "Chefia Obstetrícia", floor: "7º Andar", ramais: ["2088-1357"], icon: "Baby" },
  { id: "c59", name: "Sala de Fisioterapia", floor: "7º Andar", ramais: ["2088-1358"], icon: "UserRound" },
  { id: "c60", name: "Quarto dos Médicos", floor: "7º Andar", ramais: ["2088-1359"], icon: "BedDouble" },
  { id: "c61", name: "Epidemio / CCIH", floor: "7º Andar", ramais: ["2088-1325"], icon: "ShieldAlert" },
  // 8º Andar
  { id: "c62", name: "Hall - Recepção", floor: "8º Andar", ramais: ["2088-1360"], icon: "Users" },
  { id: "c63", name: "Sala de Parto", floor: "8º Andar", ramais: ["2088-1361"], icon: "Baby" },
  { id: "c64", name: "Equipe Médica de Plantão", floor: "8º Andar", ramais: ["2088-1362", "3878-2510"], icon: "Stethoscope" },
  { id: "c65", name: "Centro Cirúrgico", floor: "8º Andar", ramais: ["2088-1363"], icon: "Syringe" },
  { id: "c66", name: "Chefia - Anestesiologia", floor: "8º Andar", ramais: ["2088-1364"], icon: "Syringe" },
  { id: "c67", name: "UTI Materna", floor: "8º Andar", ramais: ["2088-1365"], icon: "Heart" },
  { id: "c68", name: "Equipe de Plantão - UTI Materna", floor: "8º Andar", ramais: ["2088-1366"], icon: "Stethoscope" },
  // 9º Andar
  { id: "c69", name: "Centro de Material e Esterilização", floor: "9º Andar", ramais: ["2088-1367"], icon: "FlaskConical" },
  { id: "c70", name: "Limpeza (Supervisão)", floor: "9º Andar", ramais: ["2088-1368"], icon: "Package" },
  { id: "c71", name: "Manutenção Predial (Encarregado)", floor: "9º Andar", ramais: ["2088-1369"], icon: "Wrench" },
  { id: "c72", name: "Manutenção Predial (Plantão)", floor: "9º Andar", ramais: ["2088-1370"], icon: "Wrench" },
  // 10º Andar
  { id: "c73", name: "Manutenção", floor: "10º Andar", ramais: ["2088-1371"], icon: "Wrench" },
]
